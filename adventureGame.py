...
while not (item == 'm' or item == 'f' or item == 'c' or item == 'r' or item == 's'):
    item = input('That is an invalid input. Enter m, f, c, r, or s: ')
...
if choice1 == 'y':
    ...
    while not (direction == 'north' or direction == 'south' or direction == 'east' or direction == 'west'):
        direction = input('That is an invalid input. Enter north, east, south or west: ')
    if direction == 'north':
...
while not (action == 'r' or action == 'c'):
    action = input('That is an invalid input. Enter r or c: ')
while action == 'c':
...
if answer.lower() == 'python':
    ...
    if item == 'c':
        ...
        print('CONGRATULATION! You got out safely. You won the game')
    else:
